...
namespace TraplTest
{
    ...
    public class PatternMatchingTests
    {
        ...
        public void TestPatternMatching()
        {
            ...
            ShouldPass("<gen T::<B>>",               "<A::<B>>");
            ShouldPass("<gen T::<B, gen U>>",        "<A::<B, C>>");
            ShouldPass("<gen T::<gen U, C>>",        "<A::<B, C>>");
            ShouldPass("<A::<gen T>>",               "<A::<B>>");
            ShouldPass("<A::<gen T, C>>",            "<A::<B, C>>");
            ShouldPass("<A::<gen T::<C>>>",          "<A::<B::<C>>>");
            ShouldPass("<A::<gen T::<C, gen U>>>",   "<A::<B::<C, D>>>");
            ShouldPass("<A::<gen T::<C::<gen U>>>>", "<A::<B::<C::<D>>>>");
            ShouldPass("<A::<B::<gen T::<gen U>>>>", "<A::<B::<C::<D>>>>");
            ShouldPass("<A::<B::<C::<gen T>>>>",     "<A::<B::<C::<D>>>>");
            ...
            ShouldPass("<A, gen T...>",            "<A>");
            ShouldPass("<A, gen T...>",            "<A, B>");
            ShouldPass("<A, gen T...>",            "<A, B, C>");
            ShouldPass("<A, B, gen T...>",         "<A, B>");
            ShouldPass("<A, B, gen T...>",         "<A, B, C>");
            ShouldPass("<A, B, gen T...>",         "<A, B, C, D>");
            ...
            ShouldPass("<A, gen T::<Z>...>",     "<A>");
            ShouldPass("<A, gen T::<Z>...>",     "<A, B::<Z>>");
            ShouldPass("<A, gen T::<Z>...>",     "<A, B::<Z>, C::<Z>>");
