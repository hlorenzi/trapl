...
namespace TraplTest
{
    ...
    public class TestFunct
    {
        ...
        public void TestFunctInitChecker()
        {
            ...
            Funct("let d = Data { i: 0, b: true, p: *0 }; let pd = *d; let j = @pd").Ok();
            Funct("let d = Data { i: 0, b: true, p: *0 }; let pd = *d; let i = @pd.i").Ok();
            Funct("let d = Data { i: 0, b: true, p: *0 }; let pd = *d; let b = @pd.b").Ok();
            Funct("let d = Data { i: 0, b: true, p: *0 }; let pd = *d; let p = @pd.p").Ok();
